        ...
        <div className="min-h-screen flex  overflow-hidden bg-white">
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-6  z-10">
            <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl ">
              {/* Logo */}
              <div className="mb-8 sm:mb-4 text-center flex flex-col items-center">
                <div className="w-24 sm:w-28 md:w-32 lg:w-33 xl:w-34">
                  <img
                    src={logo}
                    alt="logo"
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {isLogin && (
                  <div className="flex justify-end">
                    <button
                      ...
                      className="text-sm font-semibold text-[#db4444] hover:text-[#5a0000] transition-colors duration-200"
                    >
                      Forgot password?
                    </button>
                  </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#db4444] text-white font-bold py-3.5 rounded-xl hover:bg-[#c22727] active:scale-[0.98] transition-all shadow-md mt-4"
                >
                  {loading ? (
          ...
          <div className="hidden lg:flex w-1/2 relative overflow-hidden items-center justify-center bg-[#cd9141]">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center px-10">
                ...
                <div className="w-48 h-48 rounded-[2rem] bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl flex items-center justify-center transform rotate-3 animate-float transition-all hover:rotate-0">
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-4 -right-4 bg-[#f5f0e1] rounded-full w-14 h-14 flex items-center justify-center shadow-lg border-4 border-[#8B0000]">
                      <span className="text-[#8B0000] font-bold text-xl">
                        ✓
                      </span>
                    </div>
                  </div>
              ...
              {/* Text content */}
              <h3
                className="text-4xl sm:text-5xl font-extrabold text-[#f5f0e1] mb-6 drop-shadow-md"
                style={{ fontFamily: "'Georgia', serif" }}
              >
                Pure & Authentic
              </h3>
              <p className="text-[#f5f0e1]/90 max-w-md text-lg leading-relaxed mb-10 font-medium drop-shadow">
                Experience the true taste of tradition with our hand-picked,
                organic produce delivered straight from the farms to your
                kitchen.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 w-full max-w-lg mt-4 pt-8 border-t border-white/20">
                <div className="text-center group">
                  <div className="text-3xl font-black text-white mb-1 group-hover:scale-110 transition-transform">
                    100%
                  </div>
                  <div className="text-sm font-semibold text-[#f5f0e1]/80 uppercase tracking-wider">
                    Organic
                  </div>
                </div>
                <div className="text-center group">
